...
from fairseq.sequence_generator_from_lattice import SequenceGeneratorLattice
...
def _main(args, output_file):
    ...
    generator = task.build_generator(models, args, seq_gen_cls=SequenceGeneratorLattice)
