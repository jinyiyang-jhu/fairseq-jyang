...
This script convert edge lattice to node lattice, and sum marginal log prob to each node.
"""
...
class LatticeFromPlfExtractor:
   ...
   class _Lattice(object):
       ...
       def read_plf_line(self, line, lat_weight_scale=1.0):
           parenth_depth = 0
           plf_nodes = []
           plf_edges = []
...
if __name__ == "__main__":
   ...
   parser.add_argument('--lat_weight_scale', type=float, default=1.0, help='Scale lattice log weight')
   parser.add_argument("lat_plf_file")
   parser.add_argument("out_file")
   args = parser.parse_args()
   LatticeFromPlfExtractor().extract_to(args.lat_plf_file, args.out_file, args.lat_weight_scale)
