...
tgt_case="tc.rm"
src_case="tc"
tgtdict="exp_msa-en_bpe2000/bin_ar2en/dict.ar.txt"
srcdict="exp_msa-en_bpe2000/bin_ar2en/dict.en.txt"
src_nbpe=2000
tgt_nbpe=2000
# tgt_case="tc"
...
destdir="exp_en-msa_bpe2000_tune_with_en_from_en2ta"
fine_tune_from="exp_en-msa_bpe2000/checkpoints/checkpoint_best.pt"
